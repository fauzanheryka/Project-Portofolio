...
<p align="center">
    <kbd><img width="800" alt="Img" src="https://github.com/fauzanheryka/Project-Portofolio/assets/141212116/f369c3fd-2d9c-4c82-97c0-9a23a6ef4fb6"></kbd><br>
</p>

This documentation is like a  of my project in the data field, showing off my skills in this area, please check this.<br>
**Table of Contens :**
...
[Predict Customer Personality to Boost Marketing Campaign by Using Machine Learning](https://github.com/fauzanheryka/Predict-Customer-Personality-to-Boost-Marketing-Campaign-by-Using-Machine-Learning) | Mini Project Rakamin | Data Wraggling, EDA, clustering Kmeans | Pandas, Numpy, Matplotlib, Seaborn, Scikit-learn, Kmeans, PCA| When a business understands the personality and behavior of its clients, it may grow quickly and offer better services and perks to clients who have the potential to stick around. Our goal is to develop a cluster prediction model from this data insight so that businesses can make decisions more easily. We process past marketing campaign data to target the correct customers and enhance performance on the company's platform.
[Predict Clicked Ads Customer Classification by using Machine Learning](https://github.com/fauzanheryka/Predict-Clicked-Ads-Customer-Classification-by-using-Machine-Learning) | Mini Project Rakamin | EDA, Data Processing, Supervised Learning - Classification, Business Recomendation |pandas, matplotlib, seaborn, scikit-learn, Shap | As technology advances, businesses must be able to optimize their digital advertising tactics in order to attract new customers at the lowest possible cost. This is done to increase conversions, or the number of potential customers who make a purchase after clicking on an advertisement. However, in order to reach this goal, businesses must be able to estimate click-through rates accurately. Successfully increased CTR from 51% to 95% and increased total cost efficiency which can increase profits.
<br>
<br>
